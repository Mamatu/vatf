...
class SamplingTests(TestCase):
    ...
    def test_extract_samples(self):
        ...
        sample = samples[0]
        self.assertEqual(checksum(sample), checksum("executor/tests/data/sampling/sample_0.wav"))
        sample = samples[1]
        self.assertEqual(checksum(sample), checksum("executor/tests/data/sampling/sample_1.wav"))
